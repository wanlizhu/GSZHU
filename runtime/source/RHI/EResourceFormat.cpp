#include "GE2/RHI/EResourceFormat.h"

namespace GE2::RHI
{
    const FormatDesc kFormatDescMap[] =
    {
...
#endif
    static_assert(arraysize(kFormatDescMap) == (uint32_t)EResourceFormat::BC7UnormSrgb + 1, "Format desc table has a wrong size");
}