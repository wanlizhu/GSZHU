...
function(cm_use_eigen3)
    if (VCPKG_TOOLCHAIN)
        ...
        include("${PACKAGES_DIR}/share/eigen3/Eigen3Config.cmake")
    endif()
...
function(cm_use_nlohmann_json)
    if (VCPKG_TOOLCHAIN)
        ...
        include("${PACKAGES_DIR}/share/nlohmann_json/nlohmann_jsonConfig.cmake")
    endif()
...
function(cm_use_glfw3)
    if (VCPKG_TOOLCHAIN)
        ...
        include("${PACKAGES_DIR}/share/glfw3/glfw3Config.cmake")
        string(TOLOWER "${CMAKE_BUILD_TYPE}" _buildTypeLower)
        if ("${_buildTypeLower}" STREQUAL "debug")
            include("${PACKAGES_DIR}/share/glfw3/glfw3Targets-debug.cmake")
        else()
            include("${PACKAGES_DIR}/share/glfw3/glfw3Targets-release.cmake")
        endif()
    endif()
...
function(cm_use_imgui)
    if (VCPKG_TOOLCHAIN)
        ...
        include("${PACKAGES_DIR}/share/imgui/imguiConfig.cmake")
        string(TOLOWER "${CMAKE_BUILD_TYPE}" _buildTypeLower)
        if ("${_buildTypeLower}" STREQUAL "debug")
            include("${PACKAGES_DIR}/share/imgui/imguiConfig-debug.cmake")
        else()
            include("${PACKAGES_DIR}/share/imgui/imguiConfig-release.cmake")
        endif()
    endif()
...
function(cm_use_tinyobjloader)
    if (VCPKG_TOOLCHAIN)
        ...
        include("${PACKAGES_DIR}/share/tinyobjloader/tinyobjloader-config.cmake")
        string(TOLOWER "${CMAKE_BUILD_TYPE}" _buildTypeLower)
        if ("${_buildTypeLower}" STREQUAL "debug")
            include("${PACKAGES_DIR}/share/tinyobjloader/tinyobjloader-targets-debug.cmake")
        else()
            include("${PACKAGES_DIR}/share/tinyobjloader/tinyobjloader-targets-release.cmake")
        endif()
    endif()
