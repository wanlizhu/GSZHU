...
TEST(NTGS_Common_SignalSlot, Connection_Test) {
    {
        Connection Conn;
...
TEST(NTGS_Common_SignalSlot, ScopedConnection_Test) {
    {
...
TEST(NTGS_Common_SignalSlot, Disconnect_Test) {
    std::ostringstream Stream;
...
TEST(NTGS_Common_SignalSlot, General_Test) {
...
TEST(NTGS_Common_SignalSlot, Move_Constructed) {
...
TEST(NTGS_Common_SignalSlot, Move_Assigned) {
...
TEST(NTGS_Common_SignalSlot, Move_Assigning_With_State) {
...
TEST(NTGS_Common_SignalSlot, Accumulate_Return_Values_Of_Slots) {
...
TEST(NTGS_Common_SignalSlot, Aggregate_Return_Values_Of_Slots_Into_A_Container) {
    Signal<double(double, double)> S;
    S.Connect(std::multiplies<double>{});
    S.Connect(std::plus<double>{});
    S.Connect(std::minus<double>{});
...
TEST(NTGS_Common_SignalSlot, RValue_LValue_Using_Accumulate) {
