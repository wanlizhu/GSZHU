#include "Wanlix/Utils/System.h"
#include "Wanlix/Utils/Strings.h"
#include <filesystem>
#include <Windows.h>

namespace Wanlix
{
    String GetExtFilterString(StringArray const& filters, Bool isOpen)
    {
        String s;
        String d;
    ...
    Bool FileDialog(StringArray const& filters, String& filename, Bool isOpen)
    {
        OPENFILENAMEA ofn;
        CHAR chars[512] = "";
    ...
    EMessageBoxButton ShowMessageBox(String const& msg, EMessageBoxType type)
    {
        UINT Type = MB_OK;
        switch (type)
        {
    ...
    void FindFilesInternal(String const& name, String const& dir, Bool recursive, StringArray& result)
    {
    ...
    StringArray FindFiles(String const& filename, String const& dir, Bool recursive)
    {
    ...
    Bool FileExists(String const& filename, Bool normalFile)
    {
