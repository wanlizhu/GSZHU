...
namespace Wanlix
{
    ...
    inline bool StartsWith(std::string const& str, std::string const& prefix, bool caseSensitive = true)
    {
    ...
    inline bool EndsWith(std::string const& str, std::string const& suffix, bool caseSensitive = true)
    {
    ...
    inline std::vector<std::string> SplitString(std::string const& str, std::string const& delims)
    {
        std::string s;
    ...
    inline std::string JoinStrings(std::vector<std::string> const& strings, std::string const& separator)
    {
        std::string result;
    ...
    inline std::string TrimString(std::string const& str, bool trimLeft = true, bool trimRight = true)
    {
        std::string ret = str;
        if (trimLeft) 
        {
    ...
    inline std::string ReplaceString(std::string const& input, std::string const& src, std::string const& dst)
    {
