...
namespace Wanlix
{
    ...
    public:
        ...
        virtual void SetViewport(Uint index, const Viewport& viewport) = 0;
        virtual void SetScissor(Uint index, const Rect& rect) = 0;
        virtual void SetRenderTarget(Uint index, ITextureView* target) = 0;
        virtual void SetDepthStencilTarget(ITextureView* view) = 0;
