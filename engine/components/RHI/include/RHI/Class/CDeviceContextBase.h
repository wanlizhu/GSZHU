...
namespace Wanlix
{
    ...
    public:
        ...
        virtual IPipeline* GetPipeline() const override final;
        ...
        virtual void SetViewport(Uint index, const Viewport& viewport) override final;
        virtual void SetScissor(Uint index, const Rect& rect) override final;
        virtual void SetRenderTarget(Uint index, ITextureView* target) override final;
        virtual void SetDepthStencilTarget(ITextureView* view) override final;
