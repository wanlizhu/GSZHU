...
namespace Wanlix
{
    ...
    bool ArgVal::ToBool() const
    {
        ...
        LogWarning("Unable to convert \"", mValue, "\" to Bool.");
        return false;
    }
    ...
    Uint ArgVal::ToUint() const
    {
        ...
        {
            LogWarning("Unable to convert \"", mValue, "\" to unsigned int. Exception: ", e.what());
            return -1;
        }
        catch (std::out_of_range& e)
        {
    ...
    Uint64 ArgVal::ToUint64() const
    {
        ...
        {
            LogWarning("Unable to convert \"", mValue, "\" to unsigned int64. Exception: ", e.what());
            return -1;
        }
        catch (std::out_of_range& e)
        {
