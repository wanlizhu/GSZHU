...
namespace Wanli
{
    ...
    static inline VkFormat ToVkFormat(EPixelFormat format, bool srgb)
    {

    }

    static inline VkFormat ToVkFormat(EVertexElementType type)
    {

    }

    static inline int SizeOfElementType(EVertexElementType type)
    {
