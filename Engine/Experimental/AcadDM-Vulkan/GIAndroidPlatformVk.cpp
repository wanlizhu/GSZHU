...
namespace AutoCAD::Graphics::Engine
{
    ...
    void GIAndroidPlatformVk::RequiresInstanceExtensions(std::vector<const char*>& extensions)
    {
    ...
    void GIAndroidPlatformVk::RequiresDeviceExtensions(EGPUVendorID vendorId, std::vector<const char*>& extensions)
    {
        extensions.push_back(VK_KHR_SURFACE_EXTENSION_NAME);
        extensions.push_back(VK_KHR_ANDROID_SURFACE_EXTENSION_NAME);
        extensions.push_back(VK_GOOGLE_DISPLAY_TIMING_EXTENSION_NAME);
    ...
    void GIAndroidPlatformVk::RequiresDeviceFeatures(VkPhysicalDeviceFeatures& features)
    {}
