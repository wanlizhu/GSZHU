...
#ifdef _DEBUG
#define LOG_DEBUG(...) ((void)__android_log_print(ANDROID_LOG_DEBUG, "AcadDM", __VA_ARGS__))
#define LOG_WARNING(...) ((void)__android_log_print(ANDROID_LOG_WARNING, "AcadDM", __VA_ARGS__))
#define LOG_ERROR(...) ((void)__android_log_print(ANDROID_LOG_ERROR, "AcadDM", __VA_ARGS__))
#else
#define LOG_DEBUG(...)
#define LOG_WARNING(...)
#define LOG_ERROR(...)
...
{
    class GIAndroidPlatformVk : public GIGenericPlatformVk
    {
    public:
        static GIAndroidPlatformVk& Get();
    ...
    using GIPlatformVk = GIAndroidPlatformVk;
