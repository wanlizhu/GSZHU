...
namespace AutoCAD::Graphics::Engine
{
    ...
    VkPhysicalDevice VKInstance::GetChosenGPU() const
    {
        return mChosenPhysicalDevice;
    }

    EGPUVendorID VKInstance::GetChosenGPUVendorID() const
    {
    ...
    VKInstanceBuilder& VKInstanceBuilder::EnableLayers(const std::vector<const char*>& names)
    {
    ...
    VKInstanceBuilder& VKInstanceBuilder::EnableExtensions(const std::vector<const char*>& names)
    {
        for (const auto& name : names)
        {
    ...
    SharedPtr<VKInstance> VKInstanceBuilder::Build()
    {
        ...
        auto instance = SharedPtr<VKInstance>(new VKInstance(
            mCreateInfo, 
            mEnabledLayers,
            mEnabledExtensions));
