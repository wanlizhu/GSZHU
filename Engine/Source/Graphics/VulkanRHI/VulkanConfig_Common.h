...
namespace Wanli
{
    ...
    bool VulkanConfig::enableVsync = true;
    bool VulkanConfig::enableAsyncSubmit = true;
    bool VulkanConfig::enableValidationLayer = true;
    bool VulkanConfig::useVMA = true;
    int VulkanConfig::backbufferCount = 2;

    std::string VulkanError::ToString(VkResult error)
    {
		switch (error) 
		{
		case VK_SUCCESS:
